...
static void show_eina_strbuf_result(Evas_Object *label) {
	...
	eina_strbuf_append_printf(strbuf, "<br>%s",
			eina_strbuf_string_get(strline));
	...
	elm_object_text_set(label, eina_strbuf_string_get(strbuf)); /* Free memory */
